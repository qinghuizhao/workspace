...
int MNISTtoImage()
{
	...
	std::string filename_test_images = "/home/lin/workspace/datasetToImage/t10k-images.idx3-ubyte";
	...
	std::string filename_test_labels = "/home/lin/workspace/datasetToImage/t10k-labels.idx1-ubyte";
	...
	std::string save_test_images_path = "/home/lin/workspace/datasetToImage/test_images/";
	...
	// read MNIST image into OpenCV Mat vector
	std::string filename_train_images = "/home/lin/workspace/datasetToImage/train-images.idx3-ubyte";
	...
	// read MNIST label into int vector
	std::string filename_train_labels = "/home/lin/workspace/datasetToImage/train-labels.idx1-ubyte";
	...
	std::string save_train_images_path = "/home/lin/workspace/datasetToImage/train_images/";
	...
	// save big imags
	std::string images_path = "/home/lin/workspace/datasetToImage/train_images/";
	int width = 28 * 20;
	int height = 28 * 10;
...
int CIFAR10toImage()
{
	std::string images_path = "/home/lin/workspace/datasetToImage/CIFAR-10/cifar-10-batches-bin/";
	// train image
	std::vector<int> label_count(10, 0);
	for (int i = 1; i <= 5; i++) {
		std::string bin_name = images_path + "data_batch_" + std::to_string(i) + ".bin";
		std::string image_save_path = "/home/lin/workspace/datasetToImage/CIFAR-10/cifar-10_train/";
	...
	std::string image_save_path = "/home/lin/workspace/datasetToImage/CIFAR-10/cifar-10_test/";
	int image_count = 10000;

	read_cifar_10(bin_name, image_save_path, image_count, label_count);

	// save big imags
	images_path = "/home/lin/workspace/datasetToImage/CIFAR-10/cifar-10_train/";
	int width = 32 * 20;
	int height = 32 * 10;
...
int CIFAR100toImage()
{
	std::string images_path = "/home/lin/workspace/datasetToImage/cifar-100-binary/";
	// train image
	...
	std::string image_save_path = "/home/lin/workspace/datasetToImage/cifar-100_train/";
	...
	image_save_path = "/home/lin/workspace/datasetToImage/cifar-100_test/";
	image_count = 10000;

	read_cifar_100(bin_name, image_save_path, image_count, label_count);

	// save big imags
	images_path = "/home/lin/workspace/datasetToImage/cifar-100_train/";
	int width = 32 * 20;
	int height = 32 * 100;
	cv::Mat dst(height, width, CV_8UC3);
